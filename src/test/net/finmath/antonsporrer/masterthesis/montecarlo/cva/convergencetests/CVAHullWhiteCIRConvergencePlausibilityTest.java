...
public class CVAHullWhiteCIRConvergencePlausibilityTest {
	...
	private ConstrainedWorstCaseCVA constrainedWorstCaseCVA;
	
	public CVAHullWhiteCIRConvergencePlausibilityTest() {
		...
		pathsPerCVANumberOfCVAs.put(10, 10);
...
//		ProductConditionalFairValueProcessInterface<HullWhiteModel> productProcess = new SwapConditionalFairValueProcess<HullWhiteModel>(underlyingModel, new double[] {numberOfTimeSteps/3 * timeStepSize, 2*numberOfTimeSteps/3 * timeStepSize, numberOfTimeSteps*timeStepSize });
		...
		// Initializing the CVA calculation classes.
		
		double lossGivenDefault = 1.0;
		intensityBasedCVA = new IntensityBasedCVA(lossGivenDefault);

		constrainedWorstCaseCVA = new ConstrainedWorstCaseCVA(lossGivenDefault /* ,1.0E-50, 1.0E-50, 1.0E-50 */ );
...
//		}
	...
	public void testCouponBond() throws CalculationException, InterruptedException, ExecutionException {
...
//			testExpectationNPV(npvAndDefaultIntensitySimulation);
			...
			compareCWCCVAAndIntensityBasedCVA(npvAndDefaultIntensitySimulation, 500);
	...
	public void testSwap() throws CalculationException, InterruptedException, ExecutionException {
...
//			testExpectationNPV(npvAndDefaultIntensitySimulation);
			...
			// Compare the constrained worst case CVA and the intensity based CVA. 
			// Answer the question: How much smaller is the intensity based CVA compared to the constrained worst case CVA?
			compareCWCCVAAndIntensityBasedCVA(npvAndDefaultIntensitySimulation, 10);
	...
	public static void main(String[] args) throws CalculationException, InterruptedException, ExecutionException {
		
		CVAHullWhiteCIRConvergencePlausibilityTest cvaHullWhiteCIRConvergenceTest = new CVAHullWhiteCIRConvergencePlausibilityTest();
...
//		
	...
	public void compareCWCCVAAndIntensityBasedCVA( NPVAndDefaultIntensitySimulationInterface npvAndDefaultIntensitySimulation, double penaltyFactor) throws CalculationException, InterruptedException, ExecutionException {
		
		System.out.println( "Intensity Based CVA: " + intensityBasedCVA.getCVA(npvAndDefaultIntensitySimulation, IntegrationMethod.Trapezoidal).getAverage() );
		System.out.println( "Constrained Worst Case CVA for penalty factor " + penaltyFactor + " : " + constrainedWorstCaseCVA.getConstrainedWorstCaseCVA(npvAndDefaultIntensitySimulation, penaltyFactor) );
