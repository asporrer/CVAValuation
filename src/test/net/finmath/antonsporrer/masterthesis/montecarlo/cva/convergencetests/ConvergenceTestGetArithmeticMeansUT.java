...
/**
 * 
 * Unit test for {@link test.net.finmath.antonsporrer.masterthesis.montecarlo.cva.convergencetests.CVAHullWhiteCIRConvergenceTest #getArithmeticMeans(double[] , int , int , int )}
 * 
...
public class ConvergenceTestGetArithmeticMeansUT {
	...
	public void testBoundrySingleInput() {
		Assert.assertEquals(1337.0, CVAHullWhiteCIRConvergenceTest.getArithmeticMeans( new double[] {1337.0}, 0, 1, 1 )[0], 1E-7);
	}
	...
	public void testExample1() {
		...
		double[] arithmeticmeans1 = CVAHullWhiteCIRConvergenceTest.getArithmeticMeans(new double[] {-5.2, 1.0, 3.2, 7.2, 6.5}, 0, 2, 2 );
		Assert.assertArrayEquals(new double[] {-2.1, 5.2 }, arithmeticmeans1, 1E-7);
		System.out.println(Arrays.toString(arithmeticmeans1));
		
		double[] arithmeticmeans2 = CVAHullWhiteCIRConvergenceTest.getArithmeticMeans(new double[] {-5.4, 1.0, 3.3, 7.2, 6.5}, 0, 1, 5 );
