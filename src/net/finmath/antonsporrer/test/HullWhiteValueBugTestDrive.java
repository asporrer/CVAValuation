package net.finmath.antonsporrer.test;
...
public class HullWhiteValueBugTestDrive {
	...
	public static void main(String[] args) throws CalculationException {
		...
		////
			...
			BrownianMotionInterface brownianMotionShortRateModel = new BrownianMotionView( uncorrelatedBrownianMotion, bmFactorsForShortRateModel);
...
//			new RandomVariable(1.0).div(shortRateModel.getNumeraire(bondMaturity)).getAverage();
			
// Woran liegt die Preisveränderung des Numeraires?
// Hieran nicht:
			// warum liegts am unteren und nicht an diesem?
//			shortRateModel.getZeroCouponBond(0.05 , bondMaturity).div(shortRateModel.getNumeraire(0.05));
...
//			System.out.println("E[1/Numéraire]*N(0): " + new RandomVariable(1.0).div(shortRateModel.getNumeraire(0.5)).getAverage());
//			System.out.println("E[1/Numéraire]*N(0): " + new RandomVariable(1.0).div(shortRateModel.getNumeraire(0.5)).getAverage());
//			System.out.println("Zero Coupon Bond Price: " + shortRateModel.getZeroCouponBond(0.0, 1.0).getAverage());
			
			
			System.out.println(shortRateModel.getNumeraire(0.5));
			System.out.println(shortRateModel.getNumeraire(0.5));
			System.out.println(shortRateModel.getNumeraire(0.5));
