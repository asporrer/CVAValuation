...
package main.net.finmath.antonsporrer.masterthesis.modifiedFromFinmathLib;
...
public class HullWhiteModel extends AbstractModel implements ZCBond_ProductConditionalFairValue_ModelInterface, IntensityFunctionArgumentModelInterface  {
	...
	public RandomVariableInterface getIntensityFunctionArgument(int timeIndex,
			int componentIndex) throws CalculationException {
